...
public class MainMock {
    ...
    private static void inicializarDados() {
        ...
        // Criando disciplinas
        Disciplina disciplina1 = new Disciplina(1L, "Matemática", ETipoDisciplina.OBRIGATORIA, EEstadoDisciplina.ATIVA, professor1, new ArrayList<>());
        Disciplina disciplina2 = new Disciplina(2L, "Física", ETipoDisciplina.OBRIGATORIA, EEstadoDisciplina.ATIVA, professor2, new ArrayList<>());
